...
public class k_intent extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_k_intent);
        ...
        btn_syntax.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(k_intent.this,s_intent.class);
        ...
        btn_link.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent_link.setData(Uri.parse("https://www.codepolitan.com/mempelajari-layout-pada-android-studio"));
